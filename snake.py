...
class SnakeGame:
    ...
    def get_state(self) -> np.ndarray:
        ...
        return np.array([
            self.is_collision(Point(self.head.x+self.direction.dx, self.head.y+self.direction.dy)),
            self.is_collision(Point(self.head.x + dir_left.dx, self.head.y + dir_left.dy)),
            self.is_collision(Point(self.head.x + dir_right.dx, self.head.y + dir_right.dy)),
            ...
            self.food.y > self.head.y,
            taxicab_distance/(self.w + self.h)
        ], dtype=float)
